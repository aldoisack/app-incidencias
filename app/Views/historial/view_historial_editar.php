        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <input type="hidden" name="es_historial" id="es_historial" value="<?= true ?>" />
                    <!-- Regresar -->
                    <a id="boton_regresar" class="btn btn-danger load-content" href="<?= base_url("/historial/listar"); ?>" role="button">Regresar</a>
                </div>
                <div>
                    <!-- Reporte -->
