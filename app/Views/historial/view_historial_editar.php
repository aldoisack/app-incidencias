        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <input type="hidden" id="es_istorial" value="1" />


                    <!-- ID -->
                    <h4><b>ID: <?= $incidencia["id_incidencia"]; ?></b></h4>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-mb" name="id_categoria" id="id_categoria">
                                <option value=""> -- </option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <!-- Regresar -->
                        <a class="btn btn-danger load-content" href="<?= base_url("historial/listar"); ?>" role="button">Regresar</a>
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <div>
                            ...
                            <!-- Reporte -->
                            <a class="btn btn-info" href="<?= base_url("pdf/" . $incidencia["id_incidencia"]) ?>" target="_blank" role="button">Reporte</a>

                            <!-- Finalizar -->
                            <!-- <a class="btn btn-warning load-content" href="<?= base_url("incidencias/finalizar/" . $incidencia["id_incidencia"]) ?>" role="button">Finalizar</a> -->
